$("document").ready(function () {
  ...
  var adScroll = function () {
    ...
    if ($("#articleContentContainer").length > 0) {
      ...
      if (scrollMetric[1] === "up" && !isScolledPast(articleTop - 135)) {
        articleAd
          .removeClass("fixad")
          .removeClass("lockad-bottom")
          .addClass("lockad-top");
      } else if (
        scrollMetric[1] === "up" &&
        !isScolledPast(theHeight - screenDiff + articleTop)
      ) {
        ...
        articleAd
          .removeClass("fixad")
          .removeClass("lockad-top")
          .addClass("lockad-bottom");
      } else if (
        scrollMetric[1] === "down" &&
        isScolledPast(articleTop - 135)
      ) {
  ...
  $(".c-navigation--list").children().clone().appendTo(".standalone-menu");
